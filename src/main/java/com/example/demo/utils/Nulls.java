...
/**
 * Basically this is versions of 2 methods: etn (empty to null) and nte (null to
...
public final class Nulls {
    ...
    public static <N extends Number> N zeroToNull(N number) {
    ...
    private static <T> T checkNotNull(final T reference) {
        if (reference == null) {
            throw new IllegalArgumentException("Null is not allowed in this context!");
        }
        return reference;
    }
